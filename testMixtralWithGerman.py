...
sys_prompt: PromptTemplate = PromptTemplate(
    ...
    template="""You are an expert, and German speaker wants to ask you/Use the following pieces of context to answer the user's question
    {context}
    question: {question}. return corrent answer to German."""
)
