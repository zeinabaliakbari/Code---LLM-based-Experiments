...
class TranslationPipeline:
    ...
    def aya_translator(self, mytext):
        """
        Translates text to English using Aya 35B LLM.
        """
            ...
            for page_num, page in enumerate(pdf_reader.pages, start=1):
                ...
                if preprocessed_text:
                    ...
                    for chunk_num, chunk in enumerate(text_chunks, start=1):
                        translated_chunk = self.aya_translator(chunk)
        ...
        for filename in os.listdir(self.splited_file_directory):
            if filename.endswith('.pdf'):
                ...
                output_text_path = os.path.join(
                    ...
                    os.path.splitext(filename)[0] + '_translated_aya35b.txt'
                )
