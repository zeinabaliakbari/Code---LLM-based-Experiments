...
def extract_level_1_bookmarks(f):
            NotHaveBookmarks = []
            ...
            if len(bookmarks)>3:
                print(f"PDF is structured file and it's Title: {title}, Page Number: {page_num}")
                return "WithBookmark"
                
            else:
                
                print("there is no metadata or bookmark, the len of bookmark is : ", len(bookmarks) )
