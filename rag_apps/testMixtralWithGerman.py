...
def build_qa_chain(pdf_dir="pdf-German", db_dir="simpleDB", model_name="mixtral", embedding_model="sentence-transformers/all-MiniLM-L6-v2"):
    """
    Loads German PDFs, creates a vector store, and builds a QA chain with a German prompt.
    """
    ...
    sys_prompt = PromptTemplate(
        ...
        template=(
            "You are an expert, and a German speaker wants to ask you. "
            "Use the following pieces of context to answer the user's question.\n"
            "{context}\n"
            "question: {question}. Return correct answer in German."
        )
    )
